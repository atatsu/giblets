...
for s = 1, screen.count() do
    ...
    left_layout:add(diskusage_topleft)
    left_layout:add(mypromptbox[s])

    -- Widgets that are aligned to the bottom-left
    local left_bottomlayout = wibox.layout.fixed.horizontal()
    left_bottomlayout:add(diskusage_bottomleft)
    ...
    local right_bottomlayout = wibox.layout.fixed.horizontal()
    right_bottomlayout:add(diskusage_bottomright)
    ...
    layoutbottom:set_left(left_bottomlayout)
    layoutbottom:set_middle(mytasklist[s])
    layoutbottom:set_right(right_bottomlayout)

    mywibox[s]:set_widget(layout)
    mybottomwibox[s]:set_widget(layoutbottom)
end
-- }}}
